...
export default function DoctorAppointmentManagementPage() {
  ...
  useEffect(() => {
    const getCurrentDoctor = async () => {
      // For now, we'll get the first doctor from users table
  ...
  const filteredAppointments = appointments.filter(appointment => {
    ...
    switch (activeView) {
      ...
      case 'upcoming':
        return appointmentDate > today || (appointmentDate === today && ['scheduled', 'confirmed'].includes(appointment.status))
      case 'completed':
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Loading your appointment schedule...</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Click on an appointment to manage its details</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {selectedAppointment ? (
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {selectedAppointment.patient?.dob 
                            ? new Date().getFullYear() - new Date(selectedAppointment.patient.dob).getFullYear()
                            : 'N/A'
                          } years
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground capitalize">{selectedAppointment.patient?.gender || 'N/A'}</p>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{selectedAppointment.patient?.address}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Choose an appointment from your schedule to view patient details and manage consultation
                </p>
              </CardContent>
            </Card>
          )}
