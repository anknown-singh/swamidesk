...
import { ArrowLeft, User, Calendar, Clock, Activity, AlertCircle, PlayCircle } from 'lucide-react'
import { Alert, AlertDescription } from '@/components/ui/alert'
import type { Appointment } from '@/lib/types'

export default function DoctorTreatmentWorkflowPage() {
  ...
  const handleStartTreatment = async () => {
    ...
    try {
      ...
      // Create a visit record for treatment tracking
      const { data: visit, error: visitError } = await supabase
        ...
        .insert({
          ...
          chief_complaint: `Treatment session for ${appointment.appointment_type} appointment`,
        })
        .select()
        .single()
          ...
          <div className="flex flex-wrap gap-3">
            {['scheduled', 'confirmed', 'arrived'].includes(appointment.status) && (
              ...
              >
                ...
                {creatingVisit ? 'Starting Treatment...' : 'Start Treatment Session'}
              </Button>
            )}
