...
-- This script addresses the PGRST200 error where PostgREST can't find the relationship
...
INSERT INTO users (user_profile_id, email, role, full_name, first_name, last_name, phone, address, is_active, created_at, updated_at)
SELECT 
