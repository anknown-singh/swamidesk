-- Quick setup script for purchase_orders table
...
CREATE OR REPLACE TRIGGER purchase_orders_set_order_number
...
CREATE OR REPLACE TRIGGER purchase_order_items_updated_at
